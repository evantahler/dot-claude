...
- `docs/WRITING_STYLE.md` — The spec for writing in Evan's voice, every rule anchored to a quote from a real post: the formula, brevity, the five wit mechanisms, receipts and admitted limits, personal connection, structure, punctuation, the work-mode flex, and the split with the Arcade Technical Writing Guide, which governs technical documents. Applied by the `sound-like-evan` skill
